...
- **Migrations.** Apply in filename order (`migrations/*.sql`). Currently `001_init.sql` (puzzle + puzzle_theme) and `002_add_difficulty.sql` (adds `difficulty INT NOT NULL DEFAULT 0` to puzzle).
